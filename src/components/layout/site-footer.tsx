...
export function SiteFooter() {
  ...
  return (
    <footer className="relative z-10 flex flex-col items-center justify-between gap-1.5 border-t border-[var(--ml-border-aged)] px-4 py-1.5 text-[var(--ml-ink-muted)] sm:flex-row sm:gap-4 sm:px-8 sm:py-2.5">
